<?php
    ...
    { 
        extract($_REQUEST); 
        $result = $user->booknow($checkin, $checkout, $name, $phone, $roomname, $location, $hotelname);
        if($result)
        {
      ...
      <div class="well">
            ...
            <form action="" method="post" name="room_category">
               ...
               <div class="form-group">
                ...
                <!-- <div class="form-group">
                    <label for="location">Location:</label><input type="text" class="form-control" name="location" value="<?php echo $location ?>" required><input type="text" class="form-control" name="location" value="$location" required>
                </div> -->
